...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  20.1960
    #define DEFAULT_Ki   1.4593
    #define DEFAULT_Kd 69.8783
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 217.2788
  #define DEFAULT_bedKi 42.4373
  #define DEFAULT_bedKd 741.6450
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.00, -10.00, 0 }
